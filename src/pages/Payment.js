                ...
                <div class="w-commerce-commercelayoutcontainer w-container">
                    <div class="w-commerce-commercelayoutmain">
                        ...
                        <form data-node-type="commerce-checkout-customer-info-wrapper" class="w-commerce-commercecheckoutcustomerinfowrapper">
                            ...
                            <fieldset class="w-commerce-commercecheckoutblockcontent"><label for="wf-ecom-email" class="w-commerce-commercecheckoutlabel">Email *</label><input type="text" id="wf-ecom-email" class="w-commerce-commercecheckoutemailinput" name="email" required="" /></fieldset>
                        </form>
                        <form data-node-type="commerce-checkout-shipping-address-wrapper" class="w-commerce-commercecheckoutshippingaddresswrapper">
                            ...
                            <fieldset class="w-commerce-commercecheckoutblockcontent">
                                <label for="wf-ecom-shipping-name" class="w-commerce-commercecheckoutlabel">Full Name *</label>
                                <input type="text" id="wf-ecom-shipping-name" class="w-commerce-commercecheckoutshippingfullname" name="name" required="" />
                                <label for="wf-ecom-shipping-address" class="w-commerce-commercecheckoutlabel">Street Address *</label>
                                <input type="text" id="wf-ecom-shipping-address" class="w-commerce-commercecheckoutshippingstreetaddress" name="address_line1" required="" /><input type="text" aria-label="Shipping address optional" class="w-commerce-commercecheckoutshippingstreetaddressoptional" name="address_line2" />
                                <div class="w-commerce-commercecheckoutrow">
                                    <div class="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-shipping-city" class="w-commerce-commercecheckoutlabel">City *</label><input type="text" id="wf-ecom-shipping-city" class="w-commerce-commercecheckoutshippingcity" name="address_city" required="" /></div>
                                    <div class="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-shipping-state" class="w-commerce-commercecheckoutlabel">State/Province</label><input type="text" id="wf-ecom-shipping-state" class="w-commerce-commercecheckoutshippingstateprovince" name="address_state" /></div>
                                    <div class="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-shipping-zip" class="w-commerce-commercecheckoutlabel">Zip/Postal Code *</label><input type="text" id="wf-ecom-shipping-zip" data-node-type="commerce-checkout-shipping-zip-field" class="w-commerce-commercecheckoutshippingzippostalcode" name="address_zip" required="" /></div>
                                </div>
                                <label for="wf-ecom-shipping-country" class="w-commerce-commercecheckoutlabel">Country *</label>
                                <select id="wf-ecom-shipping-country" class="w-commerce-commercecheckoutshippingcountryselector" name="address_country">
                            ...
                            <form data-node-type="commerce-checkout-shipping-methods-wrapper" class="w-commerce-commercecheckoutshippingmethodswrapper">
                                ...
                                <fieldset>
                                    ...
                                    <div data-node-type="commerce-checkout-shipping-methods-empty-state"  class="w-commerce-commercecheckoutshippingmethodsemptystate">
                            ...
                            <div class="w-commerce-commercecheckoutpaymentinfowrapper">
                                ...
                                <fieldset class="w-commerce-commercecheckoutblockcontent"><label class="w-commerce-commercecheckoutlabel">Card Number *</label>
                                    ...
                                    <div class="w-commerce-commercecheckoutbillingaddresstogglewrapper">
                                        <input type="checkbox" id="checkbox" data-node-type="commerce-checkout-billing-address-toggle-checkbox" class="w-commerce-commercecheckoutbillingaddresstogglecheckbox" checked="" />
                                        <label for="checkbox" class="w-commerce-commercecheckoutbillingaddresstogglelabel">Billing address same as shipping</label></div>
                                </fieldset>
                            </div>
                            <div class="w-commerce-commercecheckoutpaymentinfowrapper">
                                <div class="w-commerce-commercecheckoutblockheader">
                            ...
                            <form data-node-type="commerce-checkout-billing-address-wrapper"   class="w-commerce-commercecheckoutbillingaddresswrapper">
                                <div class="w-commerce-commercecheckoutblockheader">
                                    <h4 aria-level="2">Billing Address</h4>
                                    <div>* Required</div>
                                </div>
                                <fieldset class="w-commerce-commercecheckoutblockcontent"><label for="wf-ecom-billing-name" class="w-commerce-commercecheckoutlabel">Full Name *</label>
                                    <input type="text" id="wf-ecom-billing-name" class="w-commerce-commercecheckoutbillingfullname" name="name" required="" />
                                    <label for="wf-ecom-billing-address" class="w-commerce-commercecheckoutlabel">Street Address *</label>
                                    <input type="text" id="wf-ecom-billing-address" class="w-commerce-commercecheckoutbillingstreetaddress" name="address_line1" required="" />
                                    <input type="text" aria-label="Billing address optional" class="w-commerce-commercecheckoutbillingstreetaddressoptional" name="address_line2" />
                                    <div class="w-commerce-commercecheckoutrow">
                                        <div class="w-commerce-commercecheckoutcolumn">
                                            <label for="wf-ecom-billing-city" class="w-commerce-commercecheckoutlabel">City *</label>
                                            <input type="text" id="wf-ecom-billing-city" class="w-commerce-commercecheckoutbillingcity" name="address_city" required="" />
                                        </div>
                                        <div class="w-commerce-commercecheckoutcolumn">
                                            <label for="wf-ecom-billing-state" class="w-commerce-commercecheckoutlabel">State/Province</label>
                                            <input type="text" id="wf-ecom-billing-state" class="w-commerce-commercecheckoutbillingstateprovince" name="address_state" />
                                        </div>
                                        <div class="w-commerce-commercecheckoutcolumn">
                                            <label for="wf-ecom-billing-zip" class="w-commerce-commercecheckoutlabel">Zip/Postal Code *</label>
                                            <input type="text" id="wf-ecom-billing-zip" data-node-type="commerce-checkout-billing-zip-field" class="w-commerce-commercecheckoutbillingzippostalcode" name="address_zip" required="" /></div>
                                    </div>
                                    <label for="wf-ecom-billing-country" class="w-commerce-commercecheckoutlabel">Country *</label>
                                    <select id="wf-ecom-billing-country" class="w-commerce-commercecheckoutbillingcountryselector" name="address_country">
                                        <option value="AF">Afghanistan</option>
                                        <option value="AX">Aland Islands</option>
                                        <option value="AL">Albania</option>
                                        <option value="DZ">Algeria</option>
                                    ...
                                    <div class="w-commerce-commercecheckoutorderitemswrapper">
                                        ...
                                        <fieldset class="w-commerce-commercecheckoutblockcontent">
                                            <script type="text/x-wf-template" id="wf-template-f005e781-8150-7205-215f-595036096e02"></script>
                                            <div role="list" class="w-commerce-commercecheckoutorderitemslist" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-f005e781-8150-7205-215f-595036096e02"></div>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="w-commerce-commercelayoutsidebar">
                                        <div class="w-commerce-commercecheckoutordersummarywrapper">
                                            ...
                                            <fieldset class="w-commerce-commercecheckoutblockcontent">
                                                ...
                                                <script type="text/x-wf-template" id="wf-template-f005e781-8150-7205-215f-595036096e1c">%3Cdiv%20class%3D%22w-commerce-commercecheckoutordersummaryextraitemslistitem%22%3E%3Cdiv%3E%3C%2Fdiv%3E%3Cdiv%3E%3C%2Fdiv%3E%3C%2Fdiv%3E</script>
                                                <div class="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-f005e781-8150-7205-215f-595036096e1c">
                                        ...
                                        <div data-node-type="commerce-checkout-error-state"   class="w-commerce-commercecheckouterrorstate">
