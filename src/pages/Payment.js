...
const Payment = () => {
    return (
        <>
            <div data-node-type="commerce-checkout-form-container" data-wf-checkout-query="" data-wf-page-link-href-prefix="" className="w-commerce-commercecheckoutformcontainer">
                <div className="w-commerce-commercelayoutcontainer w-container">
                    <div className="w-commerce-commercelayoutmain">
                        <div data-node-type="commerce-cart-quick-checkout-actions">
                            {/* <a data-node-type="commerce-cart-apple-pay-button" role="button" tabindex="0" aria-label="Apple Pay" aria-haspopup="dialog" style={{ "background-image": "-webkit-named-image(apple-pay-logo-white)", "background-size": "100% 50%", "background-position": "50% 50%", "background-repeat": "no-repeat" }} className="w-commerce-commercecartapplepaybutton">
                                <div></div>
                            </a> */}
                            <a data-node-type="commerce-cart-quick-checkout-button" role="button" tabindex="0" aria-haspopup="dialog" style={{ "display": "none" }} className="w-commerce-commercecartquickcheckoutbutton">
                                {/* <svg className="w-commerce-commercequickcheckoutgoogleicon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16" viewbox="0 0 16 16">
                                    <defs>
                        ...
                        <form data-node-type="commerce-checkout-customer-info-wrapper" className="w-commerce-commercecheckoutcustomerinfowrapper">
                            ...
                            <fieldset className="w-commerce-commercecheckoutblockcontent"><label for="wf-ecom-email" className="w-commerce-commercecheckoutlabel">Email *</label><input type="text" id="wf-ecom-email" className="w-commerce-commercecheckoutemailinput" name="email" required="" /></fieldset>
                        </form>
                        <form data-node-type="commerce-checkout-shipping-address-wrapper" className="w-commerce-commercecheckoutshippingaddresswrapper">
                            ...
                            <fieldset className="w-commerce-commercecheckoutblockcontent">
                                <label for="wf-ecom-shipping-name" className="w-commerce-commercecheckoutlabel">Full Name *</label>
                                <input type="text" id="wf-ecom-shipping-name" className="w-commerce-commercecheckoutshippingfullname" name="name" required="" />
                                <label for="wf-ecom-shipping-address" className="w-commerce-commercecheckoutlabel">Street Address *</label>
                                <input type="text" id="wf-ecom-shipping-address" className="w-commerce-commercecheckoutshippingstreetaddress" name="address_line1" required="" /><input type="text" aria-label="Shipping address optional" className="w-commerce-commercecheckoutshippingstreetaddressoptional" name="address_line2" />
                                <div className="w-commerce-commercecheckoutrow">
                                    <div className="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-shipping-city" className="w-commerce-commercecheckoutlabel">City *</label><input type="text" id="wf-ecom-shipping-city" className="w-commerce-commercecheckoutshippingcity" name="address_city" required="" /></div>
                                    <div className="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-shipping-state" className="w-commerce-commercecheckoutlabel">State/Province</label><input type="text" id="wf-ecom-shipping-state" className="w-commerce-commercecheckoutshippingstateprovince" name="address_state" /></div>
                                    <div className="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-shipping-zip" className="w-commerce-commercecheckoutlabel">Zip/Postal Code *</label><input type="text" id="wf-ecom-shipping-zip" data-node-type="commerce-checkout-shipping-zip-field" className="w-commerce-commercecheckoutshippingzippostalcode" name="address_zip" required="" /></div>
                                </div>
                                <label for="wf-ecom-shipping-country" className="w-commerce-commercecheckoutlabel">Country *</label>
                                <select id="wf-ecom-shipping-country" className="w-commerce-commercecheckoutshippingcountryselector" name="address_country">
                            ...
                            <div className="w-commerce-commercecheckoutpaymentinfowrapper">
                                ...
                                <fieldset className="w-commerce-commercecheckoutblockcontent"><label className="w-commerce-commercecheckoutlabel">Card Number *</label>
                                    ...
                                    <div className="w-commerce-commercecheckoutrow">
                                        <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">Expiration Date *</label>
                                        ...
                                        <div className="w-commerce-commercecheckoutcolumn"><label className="w-commerce-commercecheckoutlabel">Security Code *</label>
                                    ...
                                    <div className="w-commerce-commercecheckoutbillingaddresstogglewrapper">
                                        <input type="checkbox" id="checkbox" data-node-type="commerce-checkout-billing-address-toggle-checkbox" className="w-commerce-commercecheckoutbillingaddresstogglecheckbox" checked="" />
                                        <label for="checkbox" className="w-commerce-commercecheckoutbillingaddresstogglelabel">Billing address same as shipping</label></div>
                                </fieldset>
                            </div>
                            <div className="w-commerce-commercecheckoutpaymentinfowrapper">
                                <div className="w-commerce-commercecheckoutblockheader">
                    ...
                    <div className="w-commerce-commercelayoutsidebar">
                        <div className="w-commerce-commercecheckoutordersummarywrapper">
                            ...
                            <fieldset className="w-commerce-commercecheckoutblockcontent">
                                ...
                                <script type="text/x-wf-template" id="wf-template-f005e781-8150-7205-215f-595036096e1c">%3Cdiv%20className%3D%22w-commerce-commercecheckoutordersummaryextraitemslistitem%22%3E%3Cdiv%3E%3C%2Fdiv%3E%3Cdiv%3E%3C%2Fdiv%3E%3C%2Fdiv%3E</script>
                                <div className="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-f005e781-8150-7205-215f-595036096e1c">
                        ...
                        <a href="#" value="Place Order" data-node-type="commerce-checkout-place-order-button" className="w-commerce-commercecheckoutplaceorderbutton button" data-loading-text="Placing Order...">Place Order</a>
                        {/* <div data-node-type="commerce-checkout-error-state"  className="w-commerce-commercecheckouterrorstate">
